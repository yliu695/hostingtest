...
JSON Sample
-------------------------------------
{    "id": 19,    "name": "FQQabeNJaBNUtMTGgDPyyvDIJ",    "intro": "DhNHNTSdVPtKtMshMfUjnoGKa",    "link": "AabjFhdLeHVFKapYMEPumLtUU"}



*/

// Projects struct is a row record of the projects table in the wcs database
...
var projectsTableInfo = &TableInfo{
	Name: "projects",
	Columns: []*ColumnInfo{
...
func (p *Projects) BeforeSave() error {
	return nil
}
...
func (p *Projects) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (p *Projects) TableInfo() *TableInfo {
	return projectsTableInfo
}
