...
JSON Sample
-------------------------------------
{    "id": 22,    "name": "iBVEQSDapwAoCwOickNOSsaZD",    "job": "bCgVsWmQGGBqdXeGyTsemysfU",    "intro": "yXdkLRhXGVoatuacYYZPImjBd",    "avatar": "EcFdqBBRjJKCmuekeSswVwbWx"}



*/

// Staffs struct is a row record of the staffs table in the wcs database
type Staffs struct {
...
func (s *Staffs) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (s *Staffs) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (s *Staffs) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (s *Staffs) TableInfo() *TableInfo {
	return staffsTableInfo
}
