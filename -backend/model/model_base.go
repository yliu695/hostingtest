...
func init() {
	...
	tables["admin"] = adminTableInfo
	tables["events"] = eventsTableInfo
	tables["news"] = newsTableInfo
	tables["phds"] = phdsTableInfo
	tables["projects"] = projectsTableInfo
	tables["resources"] = resourcesTableInfo
	tables["staffs"] = staffsTableInfo
}
